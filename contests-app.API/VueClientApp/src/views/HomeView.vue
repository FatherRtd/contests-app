...
<template>
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32 mt-10">
    <div class="mt-10 flex justify-center gap-x-6 flex-col items-center">
      <div class="text-white">Проверка работы watchtower</div>
      <h1
      ...
      >
        ...
        <span class="relative whitespace-nowrap text-blue-600">
          ...
          <span class="relative">простой и понятной</span>
        </span>
        организацией.
      </h1>
      <p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        Большинство хакатонов сложно организовать и провести. Мы делаем ставку на легкость: минимум
        формальностей, максимум возможностей для ваших идей.
      </p>
    </div>
  </div>
</template>
